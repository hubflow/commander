...
ln -s ~/go/src/github.com/hubflow/dos/scripts/config/vscode/User/keybindings.json  ~/.config/'Code - Insiders'/User/keybindings.json
rm ~/.config/'Code - Insiders'/User/snippets
